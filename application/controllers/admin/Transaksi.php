...
class Transaksi extends CI_Controller {
	...
	public function kirim($kode_transaksi)
	{
		...
		<div style="text-align: left; font-weight: bold;">
			<img src="'.base_url('assets/upload/image/'.$site->icon).'" style="height: 50px; width: auto;">
		</div>');
		$mpdf->SetHTMLFooter('
			<div style="padding: 10px 20px; background-color: pink; color: white; font-size: 12px;">
				'.$site->namaweb.'<br>
