...
class Dasbor extends CI_Controller {
	...
	public function detail($kode_transaksi)
	{
		...
		// Pastikan user hanya akses data transaksi
	...
	public function profil()
	{
		...
		// Masuk databse
			...
			$i = $this->input;
			// kalo password lebih dari 6 ganti password
			...
			// Kalo kurang dari 6 ga ke ganti
			$data = array(  'id_pelanggan'			=> $id_pelanggan,
							'nama_pelanggan'        => $i->post('nama_pelanggan'),
							'telepon'   			=> $i->post('telepon'),
							'alamat'   				=> $i->post('alamat'),
		...
		// End
			...
			$this->session->set_flashdata('sukses', 'Profil telah diubah');
	...
	public function konfirmasi($kode_transaksi)
	{
		...
		$valid->set_rules('jumlah_bayar','Jumlah Pemabayaran','required',
			array(	'required'		=> '%s harus diisi'));
