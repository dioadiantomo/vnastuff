...
class Belanja extends CI_Controller {
	...
	{
		// cek pelanggan udh login atau blom, kalo blm registrasi
		...
		// Masuk database
			...
			foreach($keranjang as $keranjang) { 
				...
				$this->produk_model->edit_stok($data);
				$this->transaksi_model->tambah($data);

			}
			// End Proses masuk table transaksi
			// Setelah masuk table transaksi
			$this->cart->destroy();
	...
	public function hapus($rowid='')
	{
		...
		$this->session->set_flashdata('sukses', 'Produk dihapus');
		redirect(base_url('belanja'),'refresh');
