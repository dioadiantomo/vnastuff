	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo base_url('admin/kategori/delete/' .$kategori->id_kategori) ?>" class= "btn btn-danger btn-xs" onclick="return confirm('Yakin di Hapus?')"><i class="fa fa-trash-o"></i> Hapus</a>
			</td>	
		</tr>
		<?php $no++; } ?>
	</tbody>
