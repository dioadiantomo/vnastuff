	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo base_url('admin/user/delete/' .$user->id_user) ?>" class= "btn btn-danger btn-xs" onclick="return confirm('Yakin di Hapus?')"><i class="fa fa-trash-o"></i> Hapus</a>
			</td>	
		</tr>
		<?php $no++; } ?>
	</tbody>
